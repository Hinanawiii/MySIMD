...
void simpleGaussianElimination(float** e) {
    for (int k = 0; k < N; k++) {
        for (int j = k + 1; j < N; j++)
            e[k][j] = e[k][j] / e[k][k];
...
void sseGaussianElimination(float** e) {
    __m128 t1, t2, t3;
    for (int k = 0; k < N; k++) {
...
void avxGaussianElimination(float** e) {
    __m256 t1, t2, t3;
    for (int k = 0; k < N; k++) {
...
int main() {
    ...
    simpleGaussianElimination(test);
